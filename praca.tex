...
%   Ethereum PoS a cen
Infura jest narzędziem który pozwala na bezpieczny, wiarygodny oraz skalowalny dostęp do sieci Ethereum oraz IPFS. Infura powstała po to, by ułatwić połączenie z siecią Ethereum deweloperom po to, by mogli oni w pełni skupić się na rozwoju swoich aplikacji. Technologia ta pozwala na wejście do sieci bez potrzeby utrzymania własnego węzła. Pełny aktywny węzeł musi być w stanie utrzymać aż 1 terabajt danych, co jest o wiele więcej, niż może utrzymać typowy laptop czy też telefon.  Infura rozwiązuje problem sprzętowy bardzo efektywnie.Jest jedną z największych technologii opartych o Ethereum, jednak nie jest ona wolna od wielu problemów z utrzymaniem decentralizacji sieci. Wielu ekspertów twierdzi, że jeśli nie przestaniemy używać Infury, to cała wizja Ethereum jako zdecentralizowanej platformy przestanie istnieć. Skąd wzięły się problemy decentralizacji w tym przypadku? W tym momencie w sieci Ethereum istnieje około 11,803 pełnych węzłów \cite{website:Infura}, jednak według https://ethernodes.org ta liczba węzłów wynosi około 9000,
około 5-10\% oparte są o infrastrukturę Infury. Użytkownicy, którzy używają narzędzia Metamask do przechowywania swoich tokenów, również używają Infury, która jest mocno zależna od tego rozwiązania. Tak więc prawie wszystkie zdecentralizowane aplikacje używają rozwiązań Infury. Również pojawia się problem naszej prywatności, ponieważ infrastruktura Infury oparta jest o serwery Amazonu. Jeśli kiedykolwiek Amazon postanowi zakończyć współpracę z Infurą, wtedy wszystkie aplikacje w sieci Ethereum przestaną działać. Jednak powstaje wiele inicjatyw, które chcą osiągnąć prawdziwą decentralizację i zmniejszyć udziały Infury. Jednym z projektów jest nowa biblioteka LightJS, która została wydana przez Parity Technologies. Zadaniem tej technologii jest stworzenie lekkiego klienta, która wymaga mniej pamięci oraz zmniejsza zależność od sprzętu, przez takie działania stopień decentralizacji zwiększa się. Jednak również sami deweloperzy Infury widzą problem i próbują rozwiązać go. Finansują projekt Incubator, który pozwoli na oddzielenie się MetaMask od infrastruktury Infura. Chcą też rozwiązać problem pełnej zależności sprzętowej, którą posiada Amazon, poprzez dodanie nowych dostawców do infrastruktury\cite{website:Infura}.
