...
\begin{itemize}
    \item \textit{Ebay} Największa amerykański serwis aukcyjny na świecie. Każdy zainteresowany może stworzyć aukcję lub wziąć udział w takiej transakcji. Na eBayu możemy płaci tylko w standardowy sposób, czyli karta kredytowa lub debetowa lub za pośrednictwem PayPal. Strona nie oferuje żadnych płatności za pomocą kryptowalut. Ebay posiada regulamin, w którym jasno jest zostało zapisane jakie rzeczy można sprzedawać i w jakich przypadkach administracja podejmie kroki by zamknąć aukcję która narusza regulamin. Ebay również oferuje biuro obsługi klienta dla każdego który potrzebuje pomocy w sprawie oszustw czy też problemu z płatnościami.
    \item \textit{Allegro} Jest polskim odpowiednikiem amerykańskiej platfromy eBay. Platforma która oprócz standardowych transakcji pomiedzy użytkowikami, pozwala na umieszczanie ofert przez profesjonalnych handlarzy. Allegro posiada system ocen który ma weryfikować każdego użytkownika , jednak w trudnych przypadkach równiez oferuje pomoc w ich rozwiązaniu. Tak samo jak amerykański odpowiednik nie oferuje płatności za pomocą kryptowalut. 
\end{itemize}
