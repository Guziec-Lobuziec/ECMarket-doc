...
Celem projektu jest dostarczenie odpornej na cenzurę, ogólnodostępnej i otwartej platformy, w ramach której możliwe jest przeprowadzanie kupna oraz sprzedaży dóbr w sposób niezależny od osób trzecich lub w ramach grup handlowych tworzonych przez użytkowników systemu z określanymi przez nich zasadami.
...
Każda instrukcja wykonana na Wirtualnej Maszynie Ethereum (EVM), kosztuje pewną ilość etheru, co stanowi ograniczenie jak bardzo skomplikowany kod może być na niej wykonywany. Ten problem można częściowo rozwiązać delegując wykonanie do klientów niektórych zadań, które nie wymagają wiarygodności lub dla których można skonstruować dowód poprawności obliczeń, którego weryfikacja jest tańsza niż sam kod.
...
Istotnym problemem, którego chcielibyśmy są kwestie prawne, a więc rosnąca kontrola władzy państwowej nad różnymi aspektami życia. Rozwiązanie stanowi wydanie platformy na licencji z rodziny GPL po docelowym uzyskaniu praw autorskich od uczelni. 
...
Obecna wersja Ethereum oferuje średnią przepustowość na poziomie 15 tx/s, co może utrudniać działanie aplikacji, w przypdaku dużego zainteresowania\cite{website:ethereum2018whitepaper}.
...
Pojęcie decentralizacji będziemy rozważać pod kątem defenicji przedstawionych w artykule Vitalika Buterina \cite{website:decentralizationMeaning}, jak i innch źródłach \cite{work:Decentralization}. Dlatego będziemy ją rozważać na płaszczyźnie architektury, zarządzania i struktury logicznej.

Przed analizą wspomnianych problemów, należy zwrócić uwagę jakie rodzaje decentralizacji są pożadane w ekosystemie Ethereum i jakie są potencjalne konsekwencje ich zatracenia. Platforma ta promuje rozproszenie architektury, rozumiane jako rozproszenie wykonania kodu między różne maszyny, w idealnym wypadku w różnych lokacjach na świecie, rozproszenie zarządzania/podejmowania decyzji, definiowane jako podejmowanie decyzji, jaka wersja kodu będzie wykonywana na sprzęcie, przez niezależnych, rozsianych po świecie aktorów. Ethereum, w najbardziej pożądanej sytuacji, ulega centralizacji tylko na płaszczyźnie struktury logicznej, określanej jako spójny stan sieci, czli identyczny dla wszystkich jej uczestników.



PoW sam w sobie stanowi tylko mechanizm zabezpieczający przed spamem i atakami Sybili, jednak w kryptowalutach, poruszanych w tej pracy, jest połączny z mechanizmem wyboru bloków, tworząc algorytm rozproszonego konsensusu. 

PoW a centralizacja


Ethereum PoW a inne kryptowaluty PoW
Ethereum PoS a centralizacja
Infura
System rządów Ethereum

https://smartereum.com/3681/90-of-the-mining-power-is-owned-by-16-miners-in-bitcoin-and-11-miners-in-ethereum-says-emin-gun-sirer-el33th4xor/
...
https://chainsecurity.com/assets/files/pow.pdf
