...
\begin{itemize}
	...
	\item Web3 -- biblioteki dla różnych języków programowania, pomagające aplikacją współpracującym z siecią Ethereum na wchodzenie w interakcje kontraktami.
\end{itemize}
...
Kontrakty ,,widzą'' jedynie stan sieci. O jakiekolwiek informacje o świecie zewnętrznym muszą prosić swoich klientów, co może być wektorem ataku na nie odpowiednio przemyślany i zaprojektowany system\cite{work:ethereum2018yellowpaper,website:solidityDocs}.
...
\begin{itemize}
	\item Re-Entrancy -- klasa podatności opierająca się o race-condition, która występuje kiedy kontrakt A wywołuje (np.\ po przez wysłanie etheru) kontrakt B, a ten nieoczekiwanie wywołuje z powrotem A. Takie działanie może wprowadzić A w niepoprawny stan, pozwalający np.\ na kradzież zawartego w nim etheru lub jego zamrożenie\cite{website:TheDAOHack}. Obrona przed tymi atakami polega głównie na użyciu mutexów lub użycie wzorca \textit{checks-effects-interactions}. 
...
Pojęcie decentralizacji będziemy rozważać pod kątem defenicji przedstawionych w artykule Vitalika Buterina \cite{website:decentralizationMeaning}, jak i innch źródłach \cite{work:Decentralization}. Dlatego będziemy ją analizować na płaszczyźnie architektury, zarządzania i struktury logicznej.
...
dalej będa poruszane kwestie: Ethereum PoS a centralizacja, Infura, System rządów Ethereum (Ethereum governance)
\\
