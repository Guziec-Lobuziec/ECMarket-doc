...
\begin{itemize}
	...
	\item Dominik Dopka: \begin{itemize}
		...
		\item implementacja routingu w komponentach
		\item przygotowanie mechanizmu do przechowywania opisu w kontrakcie
		\item stworzenie testów przy implementacji umowy A1.1
		\item stworzenie testów do podsystemu zarządzania umowami
...
\begin{table}[H]
    ...
    \multirow{ 2}{*}{\textit{\textbf{Metody}}} & \multicolumn{2}{m{12cm}|}{\textit{\textbf{setSlots()} ---  ustawia slot pamięci storage}}    \\ 
		...
		&  \multicolumn{2}{m{12cm}|}{\textit{\textbf{relativeMove()} --- przesuwa wskaźnik relatywnie do jego pozycji}} \\ 
