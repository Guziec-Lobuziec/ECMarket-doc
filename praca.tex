...
W ramach projektu zespołowego razem z całym zespołem tworzyłem i analizowałem scenariusze potencjalnych umów, które mogłyby się znaleźć w naszym systemie, jak i aktywnie uczestniczyłem w tworzeniu dokumentacji. W zespole pełniłem rolę ,,społecznika'', czyli stanowiłem przeciwwagę której zadaniem było spojrzeć na całość w sposób nieco bliższy przeciętnemu użytkownikowi, który niekoniecznie musi znać wszelkie niuanse związane z Ethereum. Zgłaszałem na bieżąco swoje uwagi uczestnicząc aktywnie w redagowaniu pracy. Pokrywało się to z punktami, których realizacja przypadła mi osobiście - komercjalizacja platformy, analiza biznesowa i aspekty społeczne wraz ze wszelkim poszukiwaniem źródeł w tym zakresie. 

Od strony implementacyjnej moim zadaniem było przygotowanie mechanizmu do przechowywania opisu w kontrakcie, którego postać w ostatecznym wydaniu przez zastosowanie podejścia z maszyną stanową bardzo się zmieniła. Pomagałem przy tworzeniu umowy A1.1 oraz przygotowywałem testy - głównie w zakresie wspomnianej implementacj, ale i także podsystemu zarządzania umowami. Moje główne zadanie stanowiło przygotowanie projektu interfejsu graficznego i jego wdrożenie w życie z wykorzystaniem przygotowanych wcześniej przez zespół projektowy komponentów dodając brakujące. Zadanie to składało się na przygotowanie zupełnie nowych widoków do działających controllerów wra z z ostylowaniem całości frontendu. Przygotowałem komponent agreement-creator, wraz z formularzem i routingiem.
