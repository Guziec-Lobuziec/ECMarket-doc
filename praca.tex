...
W naszym projekcie zajmowałem się po części wszystkim, zaczynając od współudziału w analizie umów i problemów występujących w naszym systemie, na które natknęliśmy się podczas pisania pracy. \\ 

Zająłem się również przygotowaniem podstawowej wersji systemu ocen BasicRating, który miał być jedną z podstawowych właściwości naszego rozwiązania, który to ze względu na problemy natury teoretycznej został przeniesiony na drugie wydanie systemu. \\

Kolejnymi zadaniami, których się podjąłem, było stworzenie filtru do wyszukiwania umów po adresie, który został usunięty z ostatecznej wersji wydania, ponieważ okazał się niepotrzebny, stworzenie komponentu panelu bocznego w interfejsie graficznym mającym za zadanie udzielać szybkiego dostępu do pozostałych widoków/funkcjonalności, komponentu do wyszukiwania umów (search), wraz ze wstępnym wyszukiwaniem umów, jak i implementacji routingu w komponentach występujących na tamten etap zaawansowania prac, do którego również napisałem testy. \\

W ramach dokumentowania pracy, byłem odpowiedzialny za wszystkie tabelki występujące w dokumentacji, opisanie drugiego przyrostu,  proponowanego rozwiązania, planu zapewnienia jakości, infrastruktury komunikacyjnej i dokumentacyjnej jak i opisów klas i raport końcowy. Dodatkowo zająłem się redagowaniem pracy w miarę jej budowania. \\

Podczas projektu nabyłem wartościowe doświadczenie pracy w grupie, organizacji czasu i zasobów, jak i ogólnego doświadczenia pracowania nad projektem informatycznym. Praca okazała się bardzo ambitna i wymagała od nas intensywnej pracy i bezbłędnego zrozumienia tematu.
