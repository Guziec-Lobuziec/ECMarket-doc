...
Poprawnie uformowane i podpisane transakcjie, wysłane przez klientów są zbierane i grupowane przez górników (w Ethereum 2.0 walidatorów) w , które stanowią wejście do algorytmu Ethash razem z (Ethereum 2.0 będzie używać PoS). Algorytm ten odpowiada za wydobywanie bloków. Górnik, który wydobędzie
