...
\begin{itemize}
	...
	\item \textit{IDEX} oferuje tylko usługi wymiany walut \cite{website:IDEX}.
	\item \textit{OpenBazaar}nie oferuje możliwości stworzenia i podpisania kontraktu z drugą stroną, a co za tym idzie, bezpieczeństwo transakcji jest bardzo zależne od jednej ze stron \cite{website:openbazaar}. 
\end{itemize}
