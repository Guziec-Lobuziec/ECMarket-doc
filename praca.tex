...
%   Infura
\subsubsection{System rządów Ethereum}
\label{sec:SystemRzadowEthereum}

Intencją Ethereum jest dostarczenie zróżnicowanego zestawu kompromisów. Ethereum osiąga to budując coś, co jest zasadniczo ostateczną, abstrakcyjną warstwą fundamentalną: blockchain z wbudowanym językiem programowania Turinga pozwalając każdemu pisać inteligentne kontrakty i zdecentralizowane aplikacje, w których mogą tworzyć własne, dowolne reguły własności, formaty transakcji i funkcje zmiany stanu. \\
Projekt Ethereum jest zgodny z następującymi zasadami: \\
\begin{itemize}
...
\end{itemize}
Wiele z systemu rządów Ethereum to zamiary Vlada Zamfira do przygotowania sceny dla faktycznego systemu rządów Ethereum, które opisał w ,,Blockchain Governance 101\cite{website:Gov101}''. Napomina o przyświecających mu celach i w jaki sposób zamierza ich dopiąć w swoim wystąpieniu\cite{website:VladGovIntentions}.
%   selfish
