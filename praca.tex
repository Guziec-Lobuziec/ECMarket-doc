...
\begin{itemize}
	\item Re-Entrancy --- klasa podatności opierająca się o race-condition, która występuje, kiedy kontrakt A wywołuje (np.\ po przez wysłanie etheru) kontrakt B, a ten nieoczekiwanie wywołuje spowrotem A. Takie działanie może wprowadzić A w niepoprawny stan, pozwalający np.\ na kradzież zawartego w nim etheru. Obrona przed tymi atakami polega głównie na użyciu mutexów lub użycie wzorca \textit{checks-effects-interactions}. 
