...
\begin{itemize}
\item Wiarygodny system ocen
\item Niezależność od walut FIAT
\item Niezależność od stron trzecich
\item Bezpieczne wykonanie umów
\item Różnorodność umów – sposobów przeprowadzenia transakcji
\item Globalny zasięg ofert
\item Budowanie nowych rozwiązań
\end{itemize}
