...
%\vspace{6mm} aby oddzielic przyrost 2 i 3
...
\begin{table}[H]
    ...
    \hline
    \multicolumn{4}{|l|}{\textit{\textbf{Umowa A1.1 Standardowa ścieżka}}}                                                           \\ \hline
    \textit{Umowa A1.1 Standardowa ściezka}                 & \multicolumn{3}{m{13cm}|}{\textit{Sprawdzamy stworzenie umowy A1.1 z daną ceną w początkowym stanie. Użytkownik wpłaca pieniądze do kontraktu. Twórca wypłaca pieniądze. Na koniec każdy z użytkowników zamyka umowę. Umowa zostaje zakończona.}} \\ \hline
    \textit{Umowa A1.1 właściwości dołączania  :} & \multicolumn{3}{m{13cm}|}{\textit{Sprawdzamy rózne scenariusze dołączania do umowy. Sprawdzamy czy umowa posiada do trzech użytkowników maksymalnie. Sprawdzamy również czy twórca czy suplikant nie może dołączyć dwa razy do tej samej umowy.}}    \\ \hline
    \textit{Umowa A1.1 właściwości zapytania akecptacji użytkowników: } & \multicolumn{3}{l|}{\textit{Sprawdzamy możliwości akceptacji użytkowników. Sprawdzamy czy twórca nie może akcpetowac samego siebie do umowy. Sprawdzamy czy tylko twórca może akceptowa innych do dołączenia do umowy. Sprawdzamy również czy nie możemy akcepotwa kogoś gdy umowa jest w trakcie realizacji.}}                                                \\ \hline
    \textit{Umowa A1.1 właściwości stanu akceptacji użytkowników :} & \multicolumn{3}{l|}{\textit{Sprawdzamy czy nie możemy podwójnie zaakceptowac tej samej osoby. Sprawdzamy również czy nie można dołączyc do umowa gdy jest ona zamknięta.}}                                                \\ \hline
	\textit{Umowa A1.1 właściwości zamknięcia umowy:} & \multicolumn{3}{m{13cm}|}{\textit{Testujemy czy obce adresy nie mają możliwości zakończenia umowy. Sprawdzamy również czy niezaakceptowany adres nie może zamknąc umowy oraz czy nie możemy podówjnie zakończyć umowy.}} 
	\textit{Interkacja umowy z funkcją remove: }    & \multicolumn{3}{m{13cm}|}{\textit{Sprawdzamy czy różne funkcję takie jak join czy accept nie mają wpływu na usunięcie całego kontratktu. Sprawdzamy równiez czy nie możemy usunąć umowy gdy jest w stanie realizacji.}}
	\textit{Umowa A1.1 właściwości wycofania: }  & \multicolumn{3}{m{13cm}|}{\textit{W tym scenraiuszu testujemy wycofywanie się użytkownika z umowy. Sprawdzamy  czy sprzedawca nie może wycofac się z umowy. Wraz z wycofywaniem sprawdzamy czy jest możliwość wypłacenia tokenów. Sprawdzamy czy po staniu się kupującym nie może wycofac się z umowy.}}                                          \\ \hline
	\textit{AgreementManager tworzenie umów: }  & \multicolumn{3}{m{13cm}|}{\textit{Sprawdzamy czy AgreementManager pomyślnie tworzy umowę. Sprawdzamy również czy umowa istnieje pod danym adresem.}}                                          \\ \hline
	\textit{AgreementManager właściwości wyszukiwania: }  & \multicolumn{3}{m{13cm}|}{\textit{Sprawdzamy właściwości wyszukiwania AgreementManagera. Sprawdzamy czy AgreementManager pomyślnie wyszukuje pomyślnie daną umowę.}}                                          \\ \hline
\end{tabular}
\end{table}
