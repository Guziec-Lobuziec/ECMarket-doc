...
żywotnością, z którymi borykały się \[TU TRZEBA DOKONCZYC!!!\]
...
Wcześniej opisane problemy postanowiliśmy rozwiązać tworząc zdecentralizowany system do handlu ECMarket. Stworzony system pozwala na wyszukiwanie interesujących wyszukującego dóbr oraz zawarcie umów ze stroną sprzedającą. Każdy z użytkowników ma możliwość zarówno nabywania jak i sprzedawania dóbr za pomocą jednego portfelu. Aby zapewnić wiarygodność użytkownika jak i całego systemu, został zaimplementowany system ocen, który po udanej transakcji zobowiązuje użytkowników do wystawienia oceny drugiej stronie. Dostępne jest kilka wersji różnorodnych umów, które mają na celu usprawnić i ułatwić użytkownikom handel.
...
\subsection{Model Agentów Systemu}
