...
Złożoność kontraktów jest ograniczona przez limit gazu na blok, jak również maksymalny rozmiar kodu pojedynczego kontraktu, czyli ~24kB. Możliwe jest obejście tych problemów, przez rozbijanie dużych transakcji i kontraktów na mniejsze, lecz komplikuje to interakcje z tak zbudowanym systemem.
