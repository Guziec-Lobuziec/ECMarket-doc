...
Kolejnymi zadaniami, których się podjąłem, było stworzenie komponentu panelu bocznego w interfejsie graficznym, komponentu wyszukiwania umów wraz ze wstępnym wyszukiwaniem umów po nazwie, jak i implementacji routingu w komponentach, do którego również napisałem testy. \\
...
\begin{itemize}
	\item przygotowanie podstawowej wersji systemu ocen -- kod odpowiedzialny za wczesną wersję BasicRating (podstawowego systemu ocen), która została przeniesona na drugie wydanie ECMarket.
	\item stworzenie komponentu panelu bocznego -- komponent panelu bocznego, posiadający skróty do innych funkcjonalności systemu.
	\item stworzenie widoku wyszukiwania umów -- komponent wyszukiwania umów wraz ze wstępnym wyszukiwaniem po nazwie.
	\item implementacja routingu w komponentach -- dodanie routingu do wszystkich komponentów.
	\item stworzenie testów do routingu -- przygotowanie testów do routingu.
	\item udokumentowanie wszystkich tabelek, drugiego przyrostu, proponowanego rozwiązania, planu zapewnienia jakości, infrastruktury komunikacyjnej i dokumentacyjnej, opisów klas
