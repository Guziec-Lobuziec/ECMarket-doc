...
\begin{itemize}
		...
		\item przeprowadziłem rozpoznanie problemu potencjalnej centralizacji Ethereum, porównałem jak ta kwestia wygląda w przypadku innych kryptowalut, zdiagnozowałem jakie czynniki mają istotny w pływ na to zjawisko oraz jakie rozwiązania tego problemu obecnie istnieją.
		...
		\item przygotowałem zestawy ćwiczeń i materiałów, pomagających zapoznać się z Solidity iEthereum
